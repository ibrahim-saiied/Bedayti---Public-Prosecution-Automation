...
# ================= LICENSE =================
LICENSE_VERIFY_URL = "https://script.google.com/macros/s/AKfycbzCmGkCuCZpc2zHgVQxNvfuRgwUXHpPJoEHr4RyRNq7-DcFYhX8WiAN3v5oN0HGrMdm/exec"
...
def log_usage_online(license_key, timeout=10):
    payload = {
        "action": "log_usage",
        "license_key": str(license_key or "").strip(),
        "app_name": "ppo_automation",
...
class App(tk.Tk):
    def __init__(self):
        ...
        row3 = tk.Frame(self.files_frame, bg="white")
        row3.pack(fill=tk.X, pady=4)
        tk.Label(row3, text="License", bg="white").pack(side=tk.LEFT, padx=(0, 8))
        tk.Entry(row3, textvariable=self.license_key, width=30, relief="solid", bd=1).pack(side=tk.LEFT, padx=(0, 8))
